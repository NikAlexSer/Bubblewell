...
module.exports = function (t, a) {
	...
	subArr = new SubArray('offerTemplate', 'miszko');
	...
	a.deep(result, ['offerTemplate', 'miszko', 'df', 1, 3, 45, 'fef', 'elo', 'fol', null],
		"Spreable by default");

	SubArray.prototype['@@isConcatSpreadable'] = false;

	result = t.call(subArr, 'df', arr, 'fef', subArr2, null);
	a.deep(result, ['offerTemplate', 'miszko', 'df', 1, 3, 45, 'fef', subArr2, null],
		"Non spreadable");
